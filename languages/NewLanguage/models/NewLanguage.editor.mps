...
<model ref="r:07d4bf7d-0ddd-4d3c-bd17-460b92a5bed2(NewLanguage.editor)">
  ...
  <node concept="24kQdi" id="ENFp$lfXIN">
    ...
    <node concept="3EZMnI" id="ENFp$lfXK_" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="3GHFF3l2wNZ" role="3EZMnx">
        <property role="3F0ifm" value="of" />
      </node>
      <node concept="3F0A7n" id="3GHFF3l2wSE" role="3EZMnx">
        <ref role="1NtTu8" to="4c12:3GHFF3l2wBu" resolve="type" />
      </node>
      <node concept="3F0ifn" id="3GHFF3l2x4$" role="3EZMnx">
        <property role="3F0ifm" value="type" />
        <node concept="ljvvj" id="3GHFF3l2xrV" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
