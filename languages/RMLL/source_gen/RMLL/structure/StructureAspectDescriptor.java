...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptRMLL = createDescriptorForRMLL();
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptAction, myConceptInputField, myConceptInputFieldReference, myConceptLogEntry, myConceptLogger, myConceptMeasurement, myConceptMeasurementReference, myConceptOutputField, myConceptRMLL, myConceptTriggerRule);
  }
  ...
  public ConceptDescriptor getDescriptor(SConceptId id) {
    switch (myIndexSwitch.index(id)) {
      ...
      case LanguageConceptSwitch.RMLL:
        return myConceptRMLL;
  ...
  private static ConceptDescriptor createDescriptorForAction() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "Action", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0xab3ad9915390ee8L);
    b.class_(false, false, false);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/771150834208149224");
    b.version(3);
  ...
  private static ConceptDescriptor createDescriptorForInputField() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "InputField", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0x566d5c3e4db445caL);
    b.class_(false, false, false);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/6227735282384651722");
    b.version(3);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForInputFieldReference() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "InputFieldReference", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0x566d5c3e4db52986L);
    b.class_(false, false, false);
    // extends: jetbrains.mps.baseLanguage.structure.Expression
    b.super_(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/6227735282384710022");
    b.version(3);
  ...
  private static ConceptDescriptor createDescriptorForLogEntry() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "LogEntry", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0xab3ad991553dfabL);
    b.class_(false, false, false);
    // extends: RMLL.structure.TriggerRule
    b.super_(0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0xab3ad99155569e4L);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/771150834209906603");
    b.version(3);
  ...
  private static ConceptDescriptor createDescriptorForLogger() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "Logger", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0x101a5652d8a518f8L);
    b.class_(false, false, false);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/1160334767823329528");
    b.version(3);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForMeasurement() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "Measurement", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0xab3ad99153fd70fL);
    b.class_(false, false, false);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/771150834208593679");
    b.version(3);
    ...
    b.property("type", 0x101a5652d6e3a065L).type(MetaIdFactory.dataTypeId(0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0x101a5652d6e3a17dL)).origin("1160334767793872997").done();
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForMeasurementReference() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "MeasurementReference", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0xab3ad99153fe343L);
    b.class_(false, false, false);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/771150834208596803");
    b.version(3);
  ...
  private static ConceptDescriptor createDescriptorForOutputField() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "OutputField", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0x566d5c3e4db490c8L);
    b.class_(false, false, false);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/6227735282384670920");
    b.version(3);
  ...
  private static ConceptDescriptor createDescriptorForRMLL() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "RMLL", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0x566d5c3e4db17b4aL);
    b.class_(false, false, true);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.parent(0x4caf0310491e41f5L, 0x8a9b2006b3a94898L, 0x40c1a7cb987d20d5L);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/6227735282384468810");
    b.version(3);
    ...
    b.aggregate("logger", 0xab3ad991572813eL).target(0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0x101a5652d8a518f8L).optional(false).ordered(true).multiple(false).origin("771150834211914046").done();
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForTriggerRule() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("RMLL", "TriggerRule", 0x16a79f2d7a8d4f36L, 0xae28276960b9e667L, 0xab3ad99155569e4L);
    b.class_(false, false, false);
    b.origin("r:66d9b93c-f562-4f88-af54-ce6ee3a9563c(RMLL.structure)/771150834210007524");
    b.version(3);
