...
public class Measurement_Constraints extends BaseConstraintsDescriptor {
  ...
  public static class Max_Property extends BasePropertyConstraintsDescriptor {
    ...
    public boolean validateValue(SNode node, Object propertyValue, CheckingNodeContext checkingNodeContext) {
      ...
      if (!(result) && checkingNodeContext != null) {
        checkingNodeContext.setBreakingNode(new SNodePointer("r:e6d2ff38-b034-4e8b-93ae-2b6fa2e66261(RMLL.constraints)", "771150834209963600"));
      }
      return result;
    }
  ...
  public static class Min_Property extends BasePropertyConstraintsDescriptor {
    ...
    public boolean validateValue(SNode node, Object propertyValue, CheckingNodeContext checkingNodeContext) {
      boolean result = staticValidateProperty(node, SPropertyOperations.castInteger(propertyValue));
      if (!(result) && checkingNodeContext != null) {
        checkingNodeContext.setBreakingNode(new SNodePointer("r:e6d2ff38-b034-4e8b-93ae-2b6fa2e66261(RMLL.constraints)", "1160334767802779630"));
      }
      return result;
    }
    private static boolean staticValidateProperty(SNode node, int propertyValue) {
