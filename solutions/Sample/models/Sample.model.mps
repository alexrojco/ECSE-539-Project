...
<model ref="r:e719cd52-d3d0-4e45-a9f6-d96478467dfb(Sample.model)">
  ...
  <registry>
    ...
    <language id="16a79f2d-7a8d-4f36-ae28-276960b9e667" name="NewLanguage">
      ...
      <concept id="771150834208593679" name="NewLanguage.structure.Measurement" flags="ng" index="vz7Em">
        ...
        <property id="4264256496701409758" name="type" index="3I9UtI" />
      </concept>
  ...
  <node concept="rR2tO" id="5pHn3TdH3o_">
    ...
    <node concept="vTGhX" id="3GHFF3lTye0" role="vP6Fz">
      <property role="vQaXU" value="ENFp$lqJPb/below" />
      <property role="vRoax" value="200" />
      <ref role="vUTVD" node="ENFp$liYTF" resolve="Hydration" />
    </node>
    ...
    <node concept="vz7Em" id="ENFp$liY4U" role="vWS1i">
      ...
      <property role="vY5D9" value="0" />
      <property role="vZUQV" value="300" />
      <property role="3I9UtI" value="3GHFF3l2w_e/ascending" />
    </node>
    <node concept="vz7Em" id="ENFp$liYTF" role="vWS1i">
      <property role="TrG5h" value="Hydration" />
      <property role="vZUQV" value="100" />
      <property role="vY5D9" value="0" />
      <property role="3I9UtI" value="3GHFF3l2w_N/descending" />
    </node>
    <node concept="vz7Em" id="ENFp$liZdf" role="vWS1i">
      <property role="TrG5h" value="Temp " />
      <property role="vZUQV" value="42" />
      <property role="vY5D9" value="35" />
      <property role="3I9UtI" value="3GHFF3l2wyO/random" />
    </node>
